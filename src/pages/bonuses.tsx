      ...
      <LayoutComp>
        <Container size="xl" mt="xl">
          <Stack gap="sm">
            ...
            <FadeUpAni>
            <Group my={"md"} display={"flex"} justify="center" align="center" pos={"relative"}>
              <Title order={BigThenMd ? 3 : 5} ta={"center"}  display={"flex"} p={"20px 70px"} style={{ justifyContent: "center", alignItems: "center", flexDirection: "column", gap: BigThenMd ? "15px" : "15px" }}>
                <Text
                  span
                  inherit
                  c="yellow"
                ...
                <Grid.Col span={{ base: 10, md: 5 }}>
                    ...
                    <Card style={{ border: "1px solid #494949" }}>
                        <Flex gap={"sm"}>
                            ...
                            radius={"15"}
                            />
                            <Flex direction={"column"} gap={BigThenMd ? "10px" : "5px"}>
                                <Flex justify={BigThenMd ? "flex-start" : "space-between"} align={"center"} gap={"10px"}>
                                    <Title order={5}>Betr Picks</Title>
                                    <Text fz={"xs"} bg={"#0C3D1D"} style={{ padding: "5px 15px", borderRadius: "20px" }}>$500</Text>
                                </Flex>
                                <Text fz={BigThenMd ? "sm" : "xs"} opacity={"0.7"}>
                                    Get your 1st deposit matched 100% up to $500 in Bonus Credits, with Promo code StatsEdge
                                </Text>
                            </Flex>
                        </Flex>
                        <Flex justify={BigThenMd ? "space-between" : "flex-start"} direction={BigThenMd ? "row" : "column"} pt={"md"} align={BigThenMd ? "center" : "start"} gap={BigThenMd ? "0" : "5px"}>
                            <Text fz={"sm"} opacity={"0.7"}>Copy & Paste this code at Betr Picks</Text>
                            <Flex gap={"10px"} justify={BigThenMd ? "center" : "space-between"} > 
                                <Flex align={"center"} style={{ border: "1px solid #6A8BFF", borderRadius: "10px" }}>
                                    <Text fz={"xs"} px={"10px"} fw={"bold"}>StatsEdge</Text>
                                    <CopyButton value="StatsEdge">
                                      {({ copied, copy }) => (
                                        <Button fz={"xs"} p={"xs"} color={copied ? 'teal' : '#223164'} onClick={copy}>
                                          {copied ? 'Copied' : 'Copy'}
                                        </Button>
                                      )}
                                    </CopyButton>
