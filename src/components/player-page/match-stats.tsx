...
export default function MatchStats(props: MatchStatsProps) {
    ...
    return (
        ...
        <Card mah={BigThenXs ? 770 : 500} style={{ backgroundImage: "url(./blur-bg-1.png)", backgroundSize: "cover" }} p={"20px"}>
        <Title order={4} tt={"uppercase"} pb={"sm"}>Matches</Title>
        <Box mah={props.sport == 'lol' || props.sport == 'dota2' ? undefined : "400"} mih={400} style={{ overflowY: "scroll" }} py={"md"}>
